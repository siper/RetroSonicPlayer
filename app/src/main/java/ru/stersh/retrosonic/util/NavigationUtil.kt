...
import ru.stersh.retrosonic.activities.DriveModeActivity
import ru.stersh.retrosonic.activities.LicenseActivity
import ru.stersh.retrosonic.activities.SupportDevelopmentActivity
import ru.stersh.retrosonic.activities.WhatsNewFragment
import ru.stersh.retrosonic.activities.bugreport.BugReportActivity
...
object NavigationUtil {
    ...
    fun goToSupportDevelopment(activity: Activity) {
        activity.startActivity(
            Intent(activity, SupportDevelopmentActivity::class.java),
            null,
        )
    }
