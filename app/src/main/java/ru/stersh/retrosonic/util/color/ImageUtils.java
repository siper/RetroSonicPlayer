...
public class ImageUtils {
    ...
    /**
     * Classifies a color as grayscale or not. Grayscale here means "very close to a perfect gray";
     * if all three channels are approximately equal, this will return true.
     *
    ...
    public static Bitmap buildScaledBitmap(Drawable drawable, int maxWidth, int maxHeight) {
        ...
        float ratio =
                Math.min(
                        (float) maxWidth / (float) originalWidth,
