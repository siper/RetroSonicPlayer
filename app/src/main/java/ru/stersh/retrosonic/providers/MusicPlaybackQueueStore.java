...
public class MusicPlaybackQueueStore extends SQLiteOpenHelper {
    ...
    public synchronized void saveQueues(
            @NonNull final List<Song> playingQueue,
    ...
    /**
     * Clears the existing database and saves the queue into the db so that when the app is
     * restarted, the tracks you were listening to is restored
     *
