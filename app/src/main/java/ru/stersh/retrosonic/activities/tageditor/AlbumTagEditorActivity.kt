...
import ru.stersh.retrosonic.databinding.ActivityAlbumTagEditorBinding
import ru.stersh.retrosonic.extensions.appHandleColor
import ru.stersh.retrosonic.extensions.defaultFooterColor
import ru.stersh.retrosonic.extensions.isColorLight
import ru.stersh.retrosonic.extensions.setTint
...
import ru.stersh.retrosonic.model.ArtworkInfo
import ru.stersh.retrosonic.model.Song
import ru.stersh.retrosonic.util.ImageUtil
import ru.stersh.retrosonic.util.MusicUtil
import ru.stersh.retrosonic.util.RetroColorUtil.generatePalette
import ru.stersh.retrosonic.util.RetroColorUtil.getColor
...
class AlbumTagEditorActivity : AbsTagEditorActivity<ActivityAlbumTagEditorBinding>() {
    ...
    override fun loadImageFromFile(selectedFile: Uri?) {
        GlideApp
            .with(this@AlbumTagEditorActivity)
            .asBitmapPalette()
            .load(selectedFile)
