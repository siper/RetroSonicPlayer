...
import ru.stersh.retrosonic.databinding.ActivityPermissionBinding
import ru.stersh.retrosonic.extensions.accentBackgroundColor
    ...
    private fun setupTitle() {
        ...
        val appName =
            getString(
                ...
                "<b>Retro <span  style='color:$hexColor';>Sonic</span></b>",
            )
                .parseAsHtml()
