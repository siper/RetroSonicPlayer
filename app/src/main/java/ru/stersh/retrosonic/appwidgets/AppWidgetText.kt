 ...
 *
 */
package ru.stersh.retrosonic.appwidgets
...
import ru.stersh.retrosonic.appwidgets.base.BaseAppWidget
...
class AppWidgetText : BaseAppWidget() {
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setTextColor(
            R.id.title,
            ContextCompat.getColor(context, code.name.monkey.appthemehelper.R.color.md_white_1000),
        )
        appWidgetView.setTextColor(
            R.id.text,
            ContextCompat.getColor(context, code.name.monkey.appthemehelper.R.color.md_white_1000),
