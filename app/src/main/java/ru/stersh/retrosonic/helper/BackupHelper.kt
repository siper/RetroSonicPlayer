...
import ru.stersh.retrosonic.extensions.zipOutputStream
import ru.stersh.retrosonic.helper.BackupContent.CUSTOM_ARTIST_IMAGES
import ru.stersh.retrosonic.helper.BackupContent.PLAYLISTS
import ru.stersh.retrosonic.helper.BackupContent.SETTINGS
import ru.stersh.retrosonic.helper.BackupContent.USER_IMAGES
...
object BackupHelper : KoinComponent {
    ...
    private fun getSettingsZipItems(context: Context): List<ZipItem> {
        ...
        return listOf(
            ...
            ZipItem(
                File(sharedPrefPath, it).absolutePath,
                SETTINGS_PATH.child(it),
            )
        }
    }
